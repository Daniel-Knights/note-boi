...
- fix(Editor): clear undo history on note change ([5a99b4b](https://github.com/Daniel-Knights/note-boi/commit/5a99b4b920cc98b32b197e85def00c915e5e0c94))
- fix(change-password): filter out empty notes ([c5e4fa4](https://github.com/Daniel-Knights/note-boi/commit/c5e4fa4f37a51dfb54a8f3d14b73b31bddc72e66))
- perf(note): remove unnecessary new note io ([b8c9c68](https://github.com/Daniel-Knights/note-boi/commit/b8c9c68fc729a4cdec8f678d20d13c67d3416b87))
- fix(NoteMenu): menu item height difference between new note and note with title ([573f0e0](https://github.com/Daniel-Knights/note-boi/commit/573f0e054ebe09588df142d1dc10619842f6890f))
- fix(Editor): unable to press tab ([165ccdc](https://github.com/Daniel-Knights/note-boi/commit/165ccdcb4b21428e7e4658b995ea0a3c4bd70091))
- fix(Editor): adjust header picker line-height ([afeb9b4](https://github.com/Daniel-Knights/note-boi/commit/afeb9b4506977926caac33dd0111e4f7b49f644e))
- feat(ContextMenu): add confirmation dialog for note deletion ([eb1783e](https://github.com/Daniel-Knights/note-boi/commit/eb1783e0d6443dc7fbbb2d64b5f4e2439ef036b7))
- fix(sync): prevent errors on app load if not logged in ([ca2faac](https://github.com/Daniel-Knights/note-boi/commit/ca2faac8ae1425899a109d14617deb6a9f26d104))
- feat(drop menu): add hover hit box ([b753629](https://github.com/Daniel-Knights/note-boi/commit/b75362949f637c5c44f31bebba299436bce50ca9))
- feat(settings): nest update strategy in its own submenu ([0b2c789](https://github.com/Daniel-Knights/note-boi/commit/0b2c789a444927f082fefcb8440f78921ff80e36))
- fix(note menu): prevent menu closing too far after dragging past window mid point ([2a32c05](https://github.com/Daniel-Knights/note-boi/commit/2a32c052185b0eb4cd09d1242e5c641dad3aa209))
- feat(popup): use mouseup for closing ([579af1d](https://github.com/Daniel-Knights/note-boi/commit/579af1d561e66437ff0fa10a140c8e4740240f31))
- feat(utility buttons): new note menu toggle, visually move toggle and settings into editor date header ([05a8aa5](https://github.com/Daniel-Knights/note-boi/commit/05a8aa5ddedb5d4c4e998059b0f094e4a06b7c94))
- feat(menus): reorganise drop menu items, move logout to settings item ([6ae87c8](https://github.com/Daniel-Knights/note-boi/commit/6ae87c83cbc0d115d6b043a76f788dc02a3861ee))
- fix(editor): group editor format buttons for better responsiveness, and add title attributes ([83be3ab](https://github.com/Daniel-Knights/note-boi/commit/83be3ab6fbb03220d92389c56aa1d2796013167f))
- feat(mobile): mobile design ([9a34f08](https://github.com/Daniel-Knights/note-boi/commit/9a34f08ba78ce710b0fd63048df29f700aa53181))
- fix(auth): disable auth popup submit button when loading count is greater than 0 ([f9beaa6](https://github.com/Daniel-Knights/note-boi/commit/f9beaa6969cdc9567f9c234c2ad579e55aea023f))
- fix(editor): title and body whitespace parsing edge cases, ensure title and body are trimmed ([74f2fc4](https://github.com/Daniel-Knights/note-boi/commit/74f2fc4bff0a49695e41a46230828285caeb7c14))
- perf(editor): limit title and body split to first two lines ([45caa10](https://github.com/Daniel-Knights/note-boi/commit/45caa108ab6fc96da2341195fb087e2a7c30d24d))
- feat: remove sync on app exit ([5ed9d4b](https://github.com/Daniel-Knights/note-boi/commit/5ed9d4b3322acdc32e56682ad8b1ab22091dfc32))
